...
const BlogPostSchema = new mongoose_1.Schema({
    ...
    params: {
        views: { type: mongoose_1.default.SchemaTypes.Number, default: 0 },
        likes: { type: mongoose_1.default.SchemaTypes.Number, default: 0 },
        status: { type: mongoose_1.default.SchemaTypes.Number, default: 0 },
    },
    content: {
    ...
    settings: {
        visibilityCountry: { type: mongoose_1.default.SchemaTypes.String, default: "all" },
        link: mongoose_1.default.SchemaTypes.String,
        url: mongoose_1.default.SchemaTypes.String,
    },
}, {
    timestamps: true
});
